            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <a href="./race_course_races.php">
                        <i class="fa fa-angle-double-right"></i> <span>Races</span>
                    </a>
                </li>
                        <li> <a href="./race_course_calendar.php"><i class="fa fa-angle-double-right"></i>Races Calendar</a></li>
                    </ul>
                </li>
