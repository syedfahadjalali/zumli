                        ...
                        <table id="records" class="table table-striped table-bordered tableScroll" >
                            ...
                            <tbody>
                                ...
                                foreach ($publications as $publication)
                                {
                                    ...
                                    echo "<td><span class='pdf_link'><a href='".$pdflinkshow."'>URL Link</a></span></td>";
                ...
                <div class="col-md-9">
                    ...
                    <form id="custom-form" role="form" method="post" enctype="multipart/form-data" accept-charset="ISO-8859-1">
                        ...
                        <div class="form-group">
                            <label for="cover_photo">Select Cover Photo: (Size 200x220 Pixels)</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="validate[required, custom[date]] form-control date-picker" id="issue_date" placeholder="Publication issue date" name="issue_date" min="1980-01-01" max="2050-12-31" required/>
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="pdf_link">URL Link:</label>
                            <div class="input-group">
                                <span class="input-group-addon">
                                    <i class="fa fa-database"></i>
                                </span>
                                 <input type="text" id="pdf_link1" class="validate[required] form-control" name="pdf_link1" required/>
                    ...
                    <form id="custom-form" role="form" method="post" enctype="multipart/form-data" accept-charset="ISO-8859-1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input value="<?php echo $publication['issue_date'] ?>" type="text" class="validate[required, custom[date]] form-control date-picker" id="issue_date" placeholder="Publication issue date" name="issue_date" required/>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                               ...
                               <input type="text" id="pdf_link1" class="validate[required] form-control" name="pdf_link1" value="<?php echo $publication['pdf_link'] ?>"/>
...
<?php
 ...
 <script>   alert("Publications Updated Successfully");</script>
<?php
}elseif(isset($_REQUEST['msg']) && $_REQUEST['msg']=='1'){?>	
 <script>  alert("Publications Inserted Successfully");</script>
 <?php }elseif(isset($_REQUEST['msg']) && $_REQUEST['msg']=='3'){?>	
 <script>  alert("Publications Deleted Successfully");</script>
<?php } 
